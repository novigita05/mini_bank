                ...
                <div class="card">
                    ...
                    <a href="<?php echo site_url('siswa/create_lainnya'); ?>" class="btn btn-primary">Lainnya</a>
                      ...
                      <div class="form-group">
                          <label><B>Data Diri Orang Tua</B></label>
                      </div>
                      ...
                      <div class="form-group">
                          ...
                          <input class="form-control" id="" type="text" placeholder="Alamat Ayah">
                      </div>
                      ...
                      <div class="form-group">
                          ...
                          <input class="form-control" id="" type="text" placeholder="Nama Ibu">
                      </div>

                       <div class="form-group">
                          <label for="">Alamat Ibu</label>
                          <input class="form-control" id="" type="text" placeholder="Alamat Ibu">
                      </div>
